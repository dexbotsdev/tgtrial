...
export const HashtagIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 8.25h13.5m-13.5 7.5h13.5m-1.5-15L5.25 19.5" />
    </svg>
);
...
export const BeakerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 01-6.23-.693L4.2 15.3m15.6 0-1.212 6.06A3 3 0 0115.75 24h-7.5a3 3 0 01-2.838-2.64L4.2 15.3m15.6 0h-3.6" />
    </svg>
);

export const TelegramIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.17.91-.494 1.208-.822 1.23-.696.047-1.225-.46-1.9-1.088-1.055-.965-1.637-1.55-2.6-2.3-.997-.777-.358-1.192.24-1.875.116-.133.232-.266.347-.4.07-.087.14-.173.21-.26l.096-.118c.37-.452.75-.91 1.13-1.368.135-.16.27-.322.406-.484.012-.014.024-.028.035-.043.118-.15.045-.33-.09-.45-.135-.12-.333-.095-.465-.027-.123.064-1.023.68-2.834 1.954-.486.345-.913.507-1.28.5-.427-.008-1.252-.24-1.86-.44-.75-.247-1.34-.372-1.28-.77.017-.113.253-.404.708-1.03.38-.522 1.868-2.583 2.1-3.328.02-.06.04-.12.06-.18.016-.073.03-.15.046-.225.07-.324.13-.65.23-.97.11-.35.25-.7.42-1.05.17-.35.39-.7.63-1.02.2-.26.43-.51.69-.73.26-.22.56-.43.87-.6.31-.17.65-.3 1.01-.36.1-.018.21-.03.31-.033.27-.01.53.02.77.08.27.06.51.15.73.27.22.12.42.27.59.44.17.17.31.36.42.56.11.2.18.42.23.64.03.14.05.28.05.42v.03z"/>
    </svg>
);
